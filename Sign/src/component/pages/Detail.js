...
class Detail extends Component {
    ...
    componentDidMount() {
        ...
        if(document.querySelector('.detail__info-btn')){
            let isClick = true;
            console.log('run to here')
        } else {
            setTimeout(() => this.isClick(), 1000)
        }
    }
                        ...
                        <div class="row">
                            <div class="col-md-8 col-xs-12">
                                ...
                                <div class="detail__title">
                                    <h1 class="detail__title-heading mb-5">ADODDA - Vinhome Greenbay</h1>
                                    <div class="detail__title-location d-inline-flex">
                                        ...
                                        <span class="ml-2 bold">Nam Từ Liêm, Hà Nội, Việt Nam</span>
                                    </div>
                                    <div class="mt-2 detail__title-type d-flex">
                                        <svg version="1.1" viewBox="0 0 24 24" class="svg-icon svg-fill"
                                            style="width: 24px; height: 24px;">
                                            <g fill="none" fill-rule="evenodd">
                                                <circle pid="0" cx="12" cy="12" r="12" fill="#000" fill-opacity=".2"></circle>
                                                <path pid="1" fill="#FFF"
                                                    d="M7 17V8a1 1 0 011-1h8a1 1 0 011 1v9M8 7V6a1 1 0 011-1h6a1 1 0 011 1v1m-6 1a1 1 0 110 2 1 1 0 110-2zm4 0a1 1 0 110 2 1 1 0 110-2zm-4 3a1 1 0 110 2 1 1 0 110-2zm4 0a1 1 0 110 2 1 1 0 110-2zm-4 3a1 1 0 010 2 1 1 0 110-2zm4 0a1 1 0 110 2 1 1 0 010-2zm-7 3h10a1 1 0 011 1v1H6v-1a1 1 0 011-1z">
                                                </path>
                                            </g>
                                        </svg>
                                        <span class="ml-2 bold">Căn hộ chung cư</span>
                                        <span class="span"> · 28
                                    m<sup>2</sup>
                                        </span>
                                    </div>
                                ...
                                {/* <!-- Room information --> */}
                                <div class="detail__info mt-4 ">
                                    <div class="detail__info-short">
                                    ...
                                    <a class="btn detail__info-btn" onclick={() => {setTimeout( () =>  this.isClick()), 1000 }}>Đọc thêm</a>

                                </div>
                                {/* <!-- Utilities --> */}
                                <div class="detail__utilities mt-5">
                                    <div class="detail__utilities-title">
                                        <h3>Tiện nghi chỗ ở </h3>
                                        <span>Giới thiệu về các tiện nghi và dịch vụ tại nơi lưu trú</span>
                                    </div>
                                    <ul class="detail__utilities-list mt-2 d-flex">
                                        <li class="list-item mt-2">
                                            <svg version="1.1" viewBox="0 0 24 24" class="svg-icon svg-fill" alt=""
                                                style="width: 24px; height: 24px;">
                                        ...
                                        <li class="list-item mt-2">
                                            <svg version="1.1" viewBox="0 0 24 24" class="svg-icon svg-fill" alt=""
                                                ...
                                                <g fill-rule="evenodd">
                                                    ...
                                                    <path pid="1"
                                                        d="M8.428 12.428h-.037a.464.464 0 00-.468.46c0 .255.21.461.468.461h.037a.464.464 0 00.468-.46.465.465 0 00-.468-.461z">
                                                    </path>
                                                </g>
                                            </svg>
                                            <span>Khăn tắm</span>
                                        ...
                                        <li class="list-item mt-2">
                                            <svg version="1.1" viewBox="0 0 24 24" class="svg-icon svg-fill" alt=""
                                                ...
                                                <g fill-rule="evenodd" transform="translate(1)">
                                                    <path pid="0"
                                                        d="M2 0h18a2 2 0 012 2v20a2 2 0 01-2 2H2a2 2 0 01-2-2V2a2 2 0 012-2zm1 1a2 2 0 00-2 2v18a2 2 0 002 2h16a2 2 0 002-2V3a2 2 0 00-2-2H3z">
                                                    </path>
                                                    <path pid="1"
                                                        d="M11 19a8 8 0 110-16 8 8 0 010 16zm0-1a7 7 0 100-14 7 7 0 000 14z">
                                                    </path>
                                    ...
                                    <ul class="detail__utilities-list mt-2 d-flex">
                                        <li class="list-item mt-2">
                                            <svg version="1.1" viewBox="0 0 24 24" class="svg-icon svg-fill" alt=""
                                                ...
                                                <g fill-rule="evenodd">
                                                    <path pid="0"
                                                        d="M10.568 12.772a.533.533 0 00-.396-.642c-.413-.098-1.015-1-.961-1.44a.533.533 0 10-1.06-.13c-.118.974.844 2.387 1.775 2.608a.532.532 0 00.642-.396z">
                                                    </path>
                                                    <path pid="1" fill-rule="nonzero"
                                                        d="M18.896 19.245c-.105 0-.209.007-.31.02l-1.422-3.521c.7-.4 1.337-.92 1.889-1.547a8.227 8.227 0 002.026-5.36.533.533 0 00-.533-.534H6.318a.533.533 0 00-.533.534c0 .35.024.7.071 1.048H3.554a.533.533 0 100 1.067h2.52a8.223 8.223 0 001.737 3.245 7.42 7.42 0 001.827 1.51l-2.97 7.565a.533.533 0 10.993.39l.675-1.718h8.139C16.637 23.104 17.66 24 18.896 24c1.348 0 2.445-1.067 2.445-2.378 0-1.31-1.097-2.377-2.445-2.377zM8.612 13.493A7.166 7.166 0 016.873 9.37h13.118a7.166 7.166 0 01-1.739 4.123A6.382 6.382 0 0116.303 15l-.013.005a.547.547 0 00-.074.038 6.408 6.408 0 01-2.784.607c-1.131 0-2.07-.258-2.838-.633a.535.535 0 00-.094-.048l-.003-.001a6.392 6.392 0 01-1.885-1.476zm1.987 2.685c.88.354 1.836.54 2.833.54.972 0 1.905-.177 2.767-.513l1.38 3.416a2.4 2.4 0 00-1.004 1.256h-7.82l1.844-4.699zm8.297 6.755c-.76 0-1.378-.588-1.378-1.31 0-.724.618-1.312 1.378-1.312.76 0 1.378.588 1.378 1.311s-.618 1.311-1.378 1.311z">
                                                    </path>
                                                    <path pid="2"
                                                        d="M9.157 6.596a.533.533 0 10.603.88c1.742-1.196.952-2.481.572-3.099-.42-.682-.598-1.066.267-1.66a.533.533 0 10-.604-.88c-1.741 1.197-.951 2.482-.571 3.099.419.683.598 1.066-.267 1.66zm7.177 0a.533.533 0 10.604.88c1.741-1.196.951-2.481.572-3.098-.42-.683-.599-1.067.267-1.66a.533.533 0 10-.604-.88c-1.742 1.195-.952 2.48-.572 3.098.42.683.598 1.066-.267 1.66zm-3.98 0a.533.533 0 00.604.88c2.226-1.53 1.213-3.178.726-3.97-.603-.983-.876-1.643.42-2.533a.533.533 0 10-.603-.88c-2.226 1.529-1.213 3.178-.726 3.97.603.982.876 1.643-.42 2.533z">
                                                    </path>
                                                </g>
                                            </svg>
                                            <span>BBQ</span>
                                        ...
                                        <li class="list-item mt-2">
                                            <svg version="1.1" viewBox="0 0 24 24" class="svg-icon svg-fill" alt="private_pool"
                                                style="width: 24px; height: 24px;">
                                            </svg>
                                            <span>
                                                Bể bơi cá nhân
                            ...
                            <div class="col-md-4 col-xs-12">
                                ...
                                <div class="detail__booking">
                                    <div class="detail__booking-sidebar">
                                        <div class="booking-sidebar__content">
                                            {/* <!-- Price --> */}
                                            <div class="room-sidebar__price">
                                            ...
                                            {/* <!-- Booking button --> */}
                                            <button class="btn sidebar__content-btn">
